          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12 animate-slide-up">
              ...
              <div className="bg-white/15 backdrop-blur-md rounded-2xl p-4 sm:p-6 md:p-8 border border-white/20 max-w-2xl mx-auto mb-12 mx-4">
                ...
                <Button variant="cta" size="xl" className="w-full font-bold animate-pulse-glow mb-4 text-lg sm:text-xl md:text-2xl lg:text-3xl" style={{ fontSize: 'clamp(18px, 5vw, 35px)' }} onClick={() => setShowTimeSlots(true)}>
                  BOOK NOW
                </Button>
              </div>
